...
const visualSteps = [
  {
    n: "1",
    stage: "Before",
    title: "Take your stained items",
    description:
      "The staining does not have to be heavy, but maybe in a difficult area to clean.",
    images: [
      {
        src: beforeCup,
        alt: "Stained mug before cleaning",
        label: "Mug",
      },
      {
        src: beforeStrainer,
        alt: "Stained strainer before cleaning",
        label: "Strainer",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Pour in the sachet and leave to soak. The active solution works to lift stains from hard-to-reach surfaces without any scrubbing.",
    images: [
      {
        src: soakCup,
        alt: "Strainer soaking in the mug",
        label: "Active Soaking",
      },
      {
        src: soakStrainer,
        alt: "Strainer in solution lifting stains",
        label: "Stains Lifting",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Rinse thoroughly to reveal sparkling clean results. Safe for bone china, stainless steel, and melamine.",
    images: [
      { src: afterCup, alt: "Sparkling clean mug", label: "Mug" },
      {
        src: afterStrainer,
        alt: "Shiny tea strainer",
        label: "Strainer",
      },
    ],
...
export default function Usage() {
  return (
    <section id="usage" className="bg-slate-50 py-20 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-24 border-t border-slate-200 pt-20">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-base text-slate-600 sm:text-lg">
              Watch how Thermoclean removes years of stubborn coffee and tea
              stains in three simple steps.
            </p>
          </div>
